...
public class Library extends JPanel implements ActionListener {
    ...
    public Library() {
        ...
        tableShowModel = new DefaultTableModel(new Object[]
                {"Автор", "Название издания", "Издательство", "Год Издания", "Кол-во страниц", "Год", "Вес", "Этаж", "Шкаф", "Полка"}, 0) {
            @Override
    ...
    private void findByString(String textFind, int column) {
        try {
            ...
            while (result.next()) {
                ...
                String weight = result.getString("year_write");
                String floor = result.getString("weight");
                String age = result.getString("floor");
                String wardrobe = result.getString("wardrobe");
                String shelf = result.getString("shelf");
                tableShowModel.addRow(new Object[]
                        {author, publication, publishing_house, year_public, pages, weight, floor, age, wardrobe, shelf});
            }
    ...
    class PanelContact extends JPanel implements ActionListener {
        ...
        public PanelContact(String mode, String[] dataTo) {
            ...
            txtFloor = new JTextField(dataTo[7]);
            txtWardrobe = new JTextField(dataTo[10]);
            txtShelf = new JTextField(dataTo[11]);
